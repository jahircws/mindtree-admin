	    ...
	    <div class="col-12">
	    	<div class="card">
                <div class="card-header">
                    <h4>Short Course List</h4>
                    <div class="card-header-action">
                        <a class="btn btn-primary" href="<?= base_url('courseadmin/short_courses_add'); ?>"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
	    		<div class="card-body">
...
<script>
    var dataTable = $('#state_coordinator_table').DataTable({
		...
		"order" :[],
		"ajax" :{
			url:baseURL+'courseadmin/getShortCourseList',
			method:"POST",
		},
		"columnDefs":[
			{
	...
	function toggleStatus(prim_id, status) {
		...
		$.ajax({
			...
			url: baseURL+'courseadmin/changeShortCourseStatus',
			type: 'post',
